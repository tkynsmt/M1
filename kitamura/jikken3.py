...
if __name__=='__main__':
    ...
    f=open(f'F:\\B4\\b4卒論\\卒論プログラム切り詰め\\recordファイル\\record_shs_3_p={low}{high}.txt','a',encoding='UTF-8')
    f.write('shs_ratio '+'snr'+'\n')
    g=open(f'F:\\B4\\b4卒論\\卒論プログラム切り詰め\\recordファイル\\record_fovar_3_p={low}{high}.txt','a',encoding='UTF-8')
    g.write('fovar_ratio '+'snr'+'\n')
    h=open(f'F:\\B4\\b4卒論\\卒論プログラム切り詰め\\recordファイル\\record_total_3_p={low}{high}.txt','a',encoding='UTF-8')
    ...
    #グラフ作成用ファイル
    e=open(f'F:\\B4\\b4卒論\\卒論プログラム切り詰め\\forgraph保存\\forgraph_shs_3_p={high}{low}.txt','a',encoding='UTF-8')
    ...
    e=open(f'F:\\B4\\b4卒論\\卒論プログラム切り詰め\\forgraph保存\\forgraph_fovar_3_p={high}{low}.txt','a',encoding='UTF-8')
    for a in range(len(snr_box)):
        e.write(str(snr_box[a])+' ')
    e.write('\n')
    ...
    e=open(f'F:\\B4\\b4卒論\\卒論プログラム切り詰め\\forgraph保存\\forgraph_total_3_p={high}{low}.txt','a',encoding='UTF-8')
    for a in range(len(snr_box)):
        e.write(str(snr_box[a])+' ')
    e.write('\n')
